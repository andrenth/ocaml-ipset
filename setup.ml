...
(* OASIS_START *)
(* DO NOT EDIT (digest: 76a76ec2c5035adcb4a374068084fe1e) *)
(*
...
let setup_t =
  {
     ...
     test = [];
     doc = [("ipset", OCamlbuildDocPlugin.doc_build "lib")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("ipset", OCamlbuildDocPlugin.doc_clean "lib")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_c_sources = ["ipset_stubs.c"];
                      bs_data_files = [];
                      bs_ccopt =
                        [(OASISExpr.EBool true, ["-Wall"; "-Werror"])];
                      bs_cclib = [(OASISExpr.EBool true, ["-lipset"])];
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "lib_test";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "ipset"];
                   ...
                   {exec_custom = false; exec_main_is = "test_ipset.ml"; })
            ];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "!\026W\137?J\241\192*G}\186\127\174\238Y";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
